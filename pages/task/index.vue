<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input placeholder="InstanceId"
    ...
    <el-table v-loading="listLoading"
      ...
      <el-table-column label="ID"
        ...
        <template slot-scope="scope">
          ...
          <el-button size="mini"
                     type="warning"
                     @click="reactive(scope.row.id)">reactive</el-button>
        </template>
      </el-table-column>
      <el-table-column label="INSTANCEID"
                       width="110"
                       align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="DESCRIPTION"
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.description"
                     type="text"
                     @click="showdes(scope.row.description)">详情</el-button>
        </template>
      </el-table-column>
